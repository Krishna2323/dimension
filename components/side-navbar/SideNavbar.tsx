  ...
  return (
    <nav className={classes.sideNavbar}>
        ...
        <ul className={classes.sideNavbar__projectLinks}>
            <li><Link  className={classes.active} href="/"> <Image src={AppCircleSvg} alt="Dribble logo"/></Link></li>
            <li><Link href="/"> <Image src={DribbleSvg} alt="Dribble logo"/></Link></li>
            <li><Link href="/"> <Image src={BuyMeACoffeeSvg} alt="Dribble logo"/></Link></li>
            <li><Link href="/"> <Image src={AtlassianSvg} alt="Dribble logo"/></Link></li>
            <li><Link href="/"> <IoIcons.IoIosAdd style={{width:"18px",height:"18px",fill:"#533BE5",transform:'scale(1.1)'}}/></Link></li>
        </ul>
    </nav>
  )
}
